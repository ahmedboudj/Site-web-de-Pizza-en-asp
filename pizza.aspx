<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pizza.aspx.cs" Inherits="prjWebCsNapolitanaBoudj.pizza" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                <tr>
                    <td>
                        Choisir une pizza<br />
                        <asp:ListBox ID="lstPizzas" runat="server" AutoPostBack="True" Font-Bold="True" ForeColor="Blue" Height="100" Width="200" OnSelectedIndexChanged="lstPizzas_SelectedIndexChanged"></asp:ListBox>
                    </td>
                    <td>
                        <table class="inner-table">
                            <tr>
                                <th colspan="2">Gestion de la pizza sélectionnée</th>
                            </tr>
                            <tr>
                                <td>Nom :</td>
                                <td>
...
<asp:Button ID="btnAnnuler" runat="server" Text="Annuler" OnClick="btnAnnuler_Click" CssClass="button" />
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gridPizzas" runat="server" BackColor="#66FFFF" BorderStyle="Solid" BorderWidth="2" Font-Bold="True" ForeColor="#663300" Width="100%"></asp:GridView>
                    </td>
                </tr>
            </table>
        </div>
