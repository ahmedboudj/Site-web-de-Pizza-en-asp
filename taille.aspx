<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="taille.aspx.cs" Inherits="prjWebCsNapolitanaBoudj.taille" %>
...
.acceuil a.btn-orange {
    background-color: #f39c12;
}

.acceuil a.btn-orange:hover {
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="outer-table">
                <tr>
                    <td>
                        Choisir une taille<br />
                        <asp:ListBox ID="lstTailles" runat="server" AutoPostBack="True" Font-Bold="True" ForeColor="Blue" Height="100" Width="200" OnSelectedIndexChanged="lstTailles_SelectedIndexChanged"></asp:ListBox>
                    </td>
                    <td>
                        <table class="inner-table">
                            <tr>
                                <th colspan="2">Gestion de la taille sélectionnée</th>
                            </tr>
                            <tr>
                                <td>Nom :</td>
                                <td>
                                    <asp:TextBox ID="txtNom" runat="server" CssClass="textbox-style"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Taille :</td>
                                <td>
                                    <asp:TextBox ID="txtTaille" runat="server" CssClass="textbox-style"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Prix :</td>
...
<asp:Button ID="btnAnnuler" runat="server" Text="Annuler" OnClick="btnAnnuler_Click" CssClass="button" />
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gridTailles" runat="server" BackColor="#66FFFF" CssClass="gridview-style"  ForeColor="#663300" Width="100%"></asp:GridView>
                    </td>
                </tr>
            </table>
        </div>
